...
export async function insert_contactStatusLifecycle(input: any) {
  ...
  const insert_query = "INSERT INTO contact_status_lifecycle (" + cols_str +") values (" + values_str + ") returning " + all_cols_str + "";
