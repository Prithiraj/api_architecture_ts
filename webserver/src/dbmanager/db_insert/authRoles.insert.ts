...
import { authRoles_ajv } from '../../schemas/mapper_ajv'

export async function insert_authRoles(input: any) {
  // procesor
  ...
  const insert_query = {
	  text: `INSERT INTO auth_roles (${cols_str}) values (${placeholders}) returning ${all_cols_str}`,
	  values: values
  };
