...
export async function insert_bridgeContactPrimaryIncome(input: any) {
  ...
  const insert_query = "INSERT INTO bridge_contact_primary_income (" + cols_str +") values (" + values_str + ") returning " + all_cols_str + "";
