...
export async function insert_contactPermission(input: any) {
  ...
  const insert_query = "INSERT INTO contact_permission (" + cols_str +") values (" + values_str + ") returning " + all_cols_str + "";
