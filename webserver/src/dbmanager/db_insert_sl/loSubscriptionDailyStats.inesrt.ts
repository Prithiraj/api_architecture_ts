...
export async function insert_loSubscriptionDailyStats(request: any) {
  // procesor
  ...
  const additionals: any = {
    id: `lo_subscription_daily_stats_${dataKey(6)}`,
  ...
  const insert_query = `INSERT INTO lo_subscription_daily_stats (${cols_str}) values (${values_str}) returning ${all_cols_str}`;
