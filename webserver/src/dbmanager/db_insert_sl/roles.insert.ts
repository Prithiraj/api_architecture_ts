...
import { roles_ajv } from '../../schemas/mapper_ajv'

export async function insert_roles(request: any) {
  // procesor
  ...
  const insert_query = {
	  text: `INSERT INTO roles (${cols_str}) values (${placeholders}) returning ${all_cols_str}`,
	  values: values
  };
