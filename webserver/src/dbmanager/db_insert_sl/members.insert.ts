...
import { members_ajv } from '../../schemas/mapper_ajv'

export async function insert_members(request: any) {
  // procesor
  ...
  const insert_query = {
	  text: `INSERT INTO members (${cols_str}) values (${placeholders}) returning ${all_cols_str}`,
	  values: values
  };
