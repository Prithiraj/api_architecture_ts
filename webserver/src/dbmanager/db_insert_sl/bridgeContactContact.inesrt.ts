...
export async function insert_bridgeContactContact(request: any) {
  // procesor
  ...
  const additionals: any = {
    id: `bridge_contact_contact_${dataKey(6)}`,
  ...
  const insert_query = `INSERT INTO bridge_contact_contact (${cols_str}) values (${values_str}) returning ${all_cols_str}`;
