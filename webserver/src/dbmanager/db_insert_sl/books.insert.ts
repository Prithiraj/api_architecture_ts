...
import { books_ajv } from '../../schemas/mapper_ajv'

export async function insert_books(request: any) {
  // procesor
  ...
  const insert_query = {
	  text: `INSERT INTO books (${cols_str}) values (${placeholders}) returning ${all_cols_str}`,
	  values: values
  };
