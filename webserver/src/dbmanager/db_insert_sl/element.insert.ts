...
import { element_ajv } from '../../schemas/mapper_ajv'

export async function insert_element(request: any) {
  // procesor
  ...
  let pk_value: string|number = `element_${dataKey(6)}`;
  const type_of_pk = element_ajv.id.api.type;
