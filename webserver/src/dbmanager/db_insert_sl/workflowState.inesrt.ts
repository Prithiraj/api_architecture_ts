...
export async function insert_workflowState(request: any) {
  // procesor
  ...
  const insert_query = `INSERT INTO workflow_state (${cols_str}) values (${values_str}) returning ${all_cols_str}`;
