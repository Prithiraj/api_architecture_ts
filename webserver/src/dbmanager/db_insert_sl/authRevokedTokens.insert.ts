...
import { authRevokedTokens_ajv } from '../../schemas/mapper_ajv'

export async function insert_authRevokedTokens(request: any) {
  // procesor
  ...
  const insert_query = {
	  text: `INSERT INTO auth_revoked_tokens (${cols_str}) values (${placeholders}) returning ${all_cols_str}`,
	  values: values
  };
