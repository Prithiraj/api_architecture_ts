...
export async function insert_contactCustomFieldValue(request: any) {
  // procesor
  ...
  const insert_query = `INSERT INTO contact_custom_field_value (${cols_str}) values (${values_str}) returning ${all_cols_str}`;
