...
import { authors_ajv } from '../../schemas/mapper_ajv'

export async function insert_authors(request: any) {
  // procesor
  ...
  const insert_query = {
	  text: `INSERT INTO authors (${cols_str}) values (${placeholders}) returning ${all_cols_str}`,
	  values: values
  };
