...
import { activityLog_ajv } from '../../schemas/mapper_ajv'

export async function insert_activityLog(request: any) {
  // procesor
  ...
  let pk_value: string|number = `activity_log_${dataKey(6)}`;
  const type_of_pk = activityLog_ajv.id.api.type;
