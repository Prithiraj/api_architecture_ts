...
import { theme_ajv } from '../../schemas/mapper_ajv'

export async function insert_theme(request: any) {
  // procesor
  ...
  let pk_value: string|number = `theme_${dataKey(6)}`;
  const type_of_pk = theme_ajv.id.api.type;
