...
import { authUsers_ajv } from '../../schemas/mapper_ajv'

export async function insert_authUsers(request: any) {
  // procesor
  ...
  const insert_query = {
	  text: `INSERT INTO auth_users (${cols_str}) values (${placeholders}) returning ${all_cols_str}`,
	  values: values
  };
