...
export async function insert_contactCustomField(request: any) {
  // procesor
  ...
  const insert_query = `INSERT INTO contact_custom_field (${cols_str}) values (${values_str}) returning ${all_cols_str}`;
