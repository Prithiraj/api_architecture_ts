...
import { loans_ajv } from '../../schemas/mapper_ajv'

export async function insert_loans(request: any) {
  // procesor
  ...
  const insert_query = {
	  text: `INSERT INTO loans (${cols_str}) values (${placeholders}) returning ${all_cols_str}`,
	  values: values
  };
