...
export async function insert_contactComment(request: any) {
  // procesor
  ...
  const insert_query = `INSERT INTO contact_comment (${cols_str}) values (${values_str}) returning ${all_cols_str}`;
