...
export async function insert_bookShelves(request: any) {
  // procesor
  ...
  let pk_value: string|number = `book_shelves_${dataKey(6)}`;
  const type_of_pk = bookShelves_ajv.shelfId.api.type;
