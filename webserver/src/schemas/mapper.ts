...
export const filterPermission = {
  ...
  sharedAccountId: {
    key: 'sharedAccountId', dbKey: 'shared_account_id', type: 'text', required: true, foreignkey: 'user',
  },
  contactFilter: {
    key: 'contactFilter', dbKey: 'contact_filter', type: 'text', required: true, foreignkey: '',
  },
};
